package com.alimather.myjwt.common.config;

import com.alimather.myjwt.common.filters.JwtAuthenticationTokenFilter;
import com.alimather.myjwt.common.security.*;
import com.alimather.myjwt.demo.service.SelfUserDetailsService;
...
public class SpringSecurityConf extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .authorizeRequests()
                /** 允许匿名注册*/
                .antMatchers("/api/register","/druid/**")
                .permitAll()
                /** 任何请求,登录后可以访问*/
                .anyRequest()
                /**  RBAC 动态 url 认证*/
